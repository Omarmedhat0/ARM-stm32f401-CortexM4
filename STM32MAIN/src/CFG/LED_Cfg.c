...
const  LED_Config_t LEDS[_Led_Num] = {
   /*Ex : Set Led1 Configuration*/
    [Green_Light] = {.Pin = LED_PIN5,.Port = LED_PORTB,.Connection = LED_FWD,.Init_Status = LED_OFF},
    [Yellow_Light] = {.Pin = LED_PIN6,.Port = LED_PORTB,.Connection = LED_FWD,.Init_Status = LED_OFF},
    [Red_Light] = {.Pin = LED_PIN7,.Port = LED_PORTB,.Connection = LED_FWD,.Init_Status = LED_OFF}
};
