...
GPIO_enumError_t GPIO_InitPin (GPIO_Config_t *Loc_GPIOElement)
{
    ...
    GPIO_enumError_t Loc_enumReturnGPIOErrorStatus = GPIO_enumOk ;
    ...
    {
        Loc_enumReturnGPIOErrorStatus = GPIO_enumNULLPointer ; 
    }
    else if (((Loc_GPIOElement->Pin) > GPIO_PIN15) ||  ((Loc_GPIOElement->Port) > GPIO_PORTH))
    {
        Loc_enumReturnGPIOErrorStatus = GPIO_enumWrongInput ;
    }
    ...
    return Loc_enumReturnGPIOErrorStatus ; 
}
